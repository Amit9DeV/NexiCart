  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <LoadingSpinner size="xl" text="Loading furniture collection..." />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-72 h-72 bg-amber-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
          <div className="absolute top-40 right-20 w-72 h-72 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
          <div className="absolute -bottom-8 left-40 w-72 h-72 bg-yellow-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
        </div>
          ...
          <div className="py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto mb-8">
                ...
                From modern minimalism to classic elegance, find the perfect pieces for your home.
              </p>
        ...
        <div className="container-nexkartin">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-amber-100 text-amber-600 rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4">
      ...
      <section className="section-nexkartin-sm bg-gray-50">
        <div className="container-nexkartin">
          ...
          >
            <h2 className="text-2xl sm:text-3xl lg:text-heading-2 mb-4">Shop by Room</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
            {furnitureCategories.map((category, index) => (
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
