  ...
  const features = [
    {
      ...
      description: 'Professional quality gear'
    },
    {
      icon: FiShield,
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <LoadingSpinner size="xl" text="Loading sports collection..." />
      </div>
    );
  }
          ...
          <div className="py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto mb-8">
                Discover premium sports equipment and athletic gear designed for performance. 
                From fitness enthusiasts to professional athletes, find the gear that helps you achieve your goals.
              </p>
        ...
        <div className="container-nexkartin">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 text-orange-600 rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4">
        ...
        <div className="container-nexkartin">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-body text-gray-600">
              Find the perfect sports equipment for your activity
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 sm:gap-6">
            {sportsCategories.map((category, index) => (
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
