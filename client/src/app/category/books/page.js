  ...
  const features = [
    {
      ...
      description: 'Millions of titles available'
    },
    {
      icon: FiShield,
      title: 'Quality Books',
      description: 'Original and authentic'
    },
    {
      icon: FiTruck,
      title: 'Free Shipping',
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <LoadingSpinner size="xl" text="Loading books collection..." />
      </div>
    );
  }
          ...
          <div className="py-12 sm:py-16 lg:py-20">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                Discover Your
                <span className="gradient-text block"> Next Adventure</span>
              </h1>

              <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto mb-8">
                Explore a world of knowledge and imagination with our vast collection of books. 
                From bestsellers to academic texts, find the perfect read for every occasion.
              </p>
        ...
        <div className="container-nexkartin">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3 sm:mb-4">
        ...
        <div className="container-nexkartin">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-body text-gray-600">
              Find the perfect books for your interests
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 sm:gap-6">
            {booksCategories.map((category, index) => (
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
